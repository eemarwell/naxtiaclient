-- CONFIG
APP_NAME = "naxtiaonline"  -- important, change it, it's name for config dir and files in appdata
...
Services = {
  website = "http://localhost", -- currently not used
  updater = "http://localhost/api/updater.php",
  stats = "http://localhost/api/stats.php",
  crash = "http://localhost/api/crash.php",
  feedback = "http://localhost/api/feedback.php",
